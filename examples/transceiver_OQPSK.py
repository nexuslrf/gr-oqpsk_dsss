...
# Generated: Thu Oct 25 23:56:16 2018
##################################################
...
class transceiver_OQPSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/nexuslrf/Desktop/rx.txt', False)
        ...
        self.msg_connect((self.ieee802_15_4_mac_0, 'pdu out'), (self.blocks_message_debug_0, 'print'))
        ...
        self.msg_connect((self.ieee802_15_4_oqpsk_phy_0, 'rxout'), (self.blocks_message_debug_1, 'print'))
